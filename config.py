...
OWNER_ID = int(getenv("OWNER_ID", 6687721864))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/english_chatting_world_channel")
...
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://graph.org/file/69b8db5170e22e937fdda.jpg"
)
